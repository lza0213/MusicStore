...
{
    public class MusicStoreIndexController : Controller
    {
        // GET: MusicStoreIndex
        private readonly IEntityRepository<Album> _Service;
        private readonly IEntityRepository<PopularHotList> _phlService;
        public MusicStoreIndexController(IEntityRepository<Album> service, IEntityRepository<PopularHotList> phlService)
        {
